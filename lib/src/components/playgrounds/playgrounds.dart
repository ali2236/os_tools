...
class Playgrounds {
  ...
  static final personas = PlaygroundProject('personas', 'My Personas', 'My different sides.', tags: ['differed loading', 'dart', 'bootstrap-table']);
  static final fileStore = PlaygroundProject('fileStore', 'File Store', 'Library DataStore using files(fs_shim).',tags: ['databases','file','dart','angular-forms','persistence']);
